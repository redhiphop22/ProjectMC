...
public:
	...
	virtual void			ENTITY_MOVE_VELOCITY_C2S(User* user, flatbuffers::FlatBufferBuilder& fbb);
	virtual void			ENTITY_MOVE_STOP_C2S(User* user, flatbuffers::FlatBufferBuilder& fbb);
...
protected:	
	...
	virtual void			ENTITY_MOVE_VELOCITY_S2C(User* user, const char* buffer, int32_t size) {};
	virtual void			ENTITY_MOVE_STOP_S2C(User* user, const char* buffer, int32_t size) {};
